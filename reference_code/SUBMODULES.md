...
| Tool Name | Language | Primary Use | Version/Tag | Path |
|-----------|----------|-------------|-------------|------|
| Augustus | C++ | Gene prediction | N/A | `reference_code/augustus` |
| BRAKER | Perl | Gene prediction pipeline | N/A | `reference_code/braker` |
| EvidenceModeler | Perl | Gene structure combination | N/A | `reference_code/evidencemodeler` |
| MAKER | Perl | Genome annotation pipeline | N/A | `reference_code/maker` |
| PASA | Perl/C++ | Transcript assembly | N/A | `reference_code/pasa` |
| Prokka | Perl | Prokaryotic annotation | N/A | `reference_code/prokka` |
| SNAP | C | Gene prediction | N/A | `reference_code/snap` |
...
| Tool Name | Language | Primary Use | Version/Tag | Path |
|-----------|----------|-------------|-------------|------|
| Bismark | Perl | Bisulfite-seq alignment | N/A | `reference_code/bismark` |
| Segway | Python | Genome segmentation | N/A | `reference_code/segway` |
| methylKit | R | DNA methylation | N/A | `reference_code/methylkit` |
...
| Tool Name | Language | Primary Use | Version/Tag | Path |
|-----------|----------|-------------|-------------|------|
| IQ-TREE | C++ | Phylogenetic inference | N/A | `reference_code/iq_tree` |
| MrBayes | C | Bayesian phylogenetics | N/A | `reference_code/mrbayes` |
| PhyML | C | Maximum likelihood | N/A | `reference_code/phyml` |
| RAxML | C | Maximum likelihood trees | N/A | `reference_code/raxml` |
...
| Tool Name | Language | Primary Use | Version/Tag | Path |
|-----------|----------|-------------|-------------|------|
| PRINSEQ | Perl | Sequence quality control | N/A | `reference_code/prinseq` |
