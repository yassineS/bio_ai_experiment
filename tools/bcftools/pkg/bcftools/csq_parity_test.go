...
// csqParityDir holds the brief/gencode csq parity fixtures: the input
// VCF, the GFF3 annotation and the reference FASTA. Unlike a golden-file
// setup, the expected INFO/BCSQ renderings are NOT committed — the live
// upstream-parity test (TestCSQ_BriefGencodeUpstreamParity) computes them
// in-process by running the upstream bcftools binary.
...
// =====================================================================
// Brief / gencode parity (from #223): translation tables, brief
// truncation, -B/--trim-protein-seq validation, and a live -b/-B/-C
// upstream comparison over a dedicated fixture.
// =====================================================================

// renderCSQBCSQ runs the haplotype-aware Go engine over the brief/gencode
// parity fixture with the given options and renders one
//
...
// built once on demand (via the shared upstreamBcftools helper); a genuine
// build failure is a hard error (t.Fatalf), never a skip.
