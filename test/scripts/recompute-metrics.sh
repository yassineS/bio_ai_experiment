...
#
# Usage:  test/scripts/recompute-metrics.sh            # print a markdown table
#         test/scripts/recompute-metrics.sh > out.md   # capture
#
...
Generated $gen_date from \`$head_commit\` by \`test/scripts/recompute-metrics.sh\`.
