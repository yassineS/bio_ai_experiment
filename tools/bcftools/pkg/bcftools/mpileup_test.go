...
func TestMpileupKeepRecordFilters(t *testing.T) {
	...
	// SECONDARY | QCFAIL | DUP. The hardcoded copy in mpileupKeepRecord
	// was removed so callers who construct MpileupOptions by hand are
	// expected to either go through validateMpileupOptions or set the
	// mask themselves.
