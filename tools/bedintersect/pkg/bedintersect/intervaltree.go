...
//
// The IntervalTree type used here was lifted into `pkg/htsgo/bed` so it
...
// IntervalNode is an alias for bed.IntervalNode (see pkg/htsgo/bed/intervaltree.go).
type IntervalNode = bed.IntervalNode

// IntervalTree is an alias for bed.IntervalTree (see pkg/htsgo/bed/intervaltree.go).
